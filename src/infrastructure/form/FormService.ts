...
import { IFormServicePort, IFormStatePort } from 'core/ports/IFormPort'

export class FormState<T> implements IFormStatePort<T> {
  data: T
...
export class FormService<T> implements IFormServicePort<T> {
