    ...
    <div className="flex size-full flex-1 flex-col gap-10">
      <div className="flex size-full flex-col items-center justify-center gap-10">
        <div className="relative flex flex-col items-center gap-2">
          ...
          <Button className="w-fit" size="S" rounded="LBottom" disabled variant={'standard'}>
            Withdraw under maintenance
          </Button>
        </div>
        {enoughForToday ? (
          <span className="body3">Come back tomorrow with your next 10 clicks to earn more (: 😈</span>
        ) : (
          <Button
            className="w-fit"
            rounded="RBottom"
