...
export const PageLayout = (props: Props) => {
  return (
    <>
      ...
      <div className="flex h-screen w-screen flex-col items-center justify-center sm:pb-5">
        {/*header*/}
        ...
        {/*main*/}
        <div className="container z-10 mx-auto flex h-full items-center justify-center rounded-b-3xl border border-black bg-white">
          {props.children}
        </div>
      </div>
    </>
